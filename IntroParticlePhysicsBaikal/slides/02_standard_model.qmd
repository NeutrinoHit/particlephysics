...
subtitle: "The Most Successful Merge Of Conflicting Principles"
...
::: {.incremental}
- A model in the framework of quantum field theory
  - unifies *electromagnetic* and *weak* interactions as **electroweak interactions**
  - formally unifies electroweak and **strong interactions**

- Non-trivial phenomena
  - **local symmetries**: predict non-trivial interactions of quantum fields
  - **spontaneous breaking of symmetries**: transform massless fields into massive
  - **quantum anomalies**: breaking classical conservation laws. Non-perturbative physics
  - **Higgs Field and Higgs Boson**: was a central problem in physics during 45 years
:::
...
## Search for the Unity of Phenomena
...
- Electric and magnetic fields are different readings of that object.
...
::: {.question}
A charged particle flies past a magnet with non-zero speed $v$.
:::
...
| Low-energy strength | everyday strong | about $10^7$--$10^8$ times weaker |
...
# How to Build a theory of Interactions when there is no classical analogy?
...
- The theory disagree with Galileo's principle of relativity but agreed with Einstein's principle of relativity.  Thus, 
$$
\mathbf{E},\mathbf{B}\to A^\mu
$$

- Least action principle gives a receipt:
$$
...
## Three friends-physicists story
:::: {.columns}
...
- The theorist says: 
  - "We have to know the electron field at two astrophysically distant points. You should go there and measure it".
  - "Remember, the phase of the electron field is a convention. You can choose it arbitrarily at each point."
- Experimentalists took flights to very-very distant destinations $x$ and $y$ with only one-way communication.  
:::
...
## Three friends-physicists story. A problem 
::: incremental
...
- The problem is even worse. For two infinitesimally close points he cannot calculate the derivative $\partial_\mu \psi(x)$. Thus, even a *free* theory is not well-defined!
...
$$
- We got the QED!
- As a bonus, the mass of photon is zero. Otherwise, $$m_A^2A_\mu A^\mu$$ is not invariant under the gauge transformation.
:::
:::
...
## Scalar Electrodynamics Example of Gauge invariance
::: incremental
...
## The Algorithm 
::: incremental
- Now we have a new method **gauge invariance** to predict the interaction 
- The algorithm is simple:
  - Take a free theory 
  - Replace $\partial_\mu\to D_\mu$
  - Introduce compensating fields $A^\mu_i$ with the number equal to the number of generators in your free theory symmetry group
  - Introduce $F_{\mu\nu}$ and gauge-invariant lagrangian for it.
  - Enjoy a new interaction theory!
:::
...
SU(2)_L\times U(1)_Y
$$
  - it requires zero masses for all particles: fermions and gauge bosons. This is not good.

2. A symmetry breaking mechanism
  - it gives masses to particles 
:::
:::

::: {.column width="20%"}
::: {.media-figure style="--media-max-height: 205px; --media-bg: transparent; --media-shadow: none;"}
...
## Secret Origin of Mass

::: incremental
- Modern Physics suggests: the masses appear dynamically shortly after the **Big Bang** because of a phase transition.
- After the phase transition a scalar (Higgs) field was condensed and this lead to masses of particles.
- Methaphorically, we leave inside of a **superconductor**.
- There are two distinct mechanisms of mass generation:
  - for gauge vector bosons
  - for fermions.
...
::: incremental
- Higgs scalar field has a **screening** current:
$$
j^\mu = -e^2 v^2 A^\mu
$$
...
- Condensate behaves like a superconductor.
...
- Without condensate, $R$ and $L$ move independently at $c$.
- Condensate couples them: left sources right, and right sources left.
$$
m_f=\frac{y_fv}{\sqrt2}.
$$
